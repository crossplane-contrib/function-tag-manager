...
spec:
  package: xpkg.upbound.io/crossplane-contrib/function-tag-manager:v0.8.0
```
...
```shell
up xpkg push xpkg.upbound.io/crossplane-contrib/function-tag-manager:v0.8.0 -f function-tag-manager.xpkg
```
